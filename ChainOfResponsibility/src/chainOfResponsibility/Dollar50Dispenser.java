...
/**
 * Clase que implementa el dispensador de billetes de $50 en el patrón Chain of
 * Responsibility. Esta clase maneja la dispensación de billetes de $50 y pasa
...
public class Dollar50Dispenser implements DispenseChain {
    ...
    /**
     * Método para dispensar billetes de $50. Si la cantidad de dinero es mayor
     * o igual a $50, se dispensan billetes de $50 y se calcula el sobrante. Si
     * hay una cantidad restante, se pasa al siguiente dispensador. Si la
     * cantidad es menor a $50, se pasa directamente al siguiente dispensador.
     *
    ...
    public void dispense(Currency currency) {
        if (currency.getCantidad() >= 50) {
            int num = currency.getCantidad() / 50;
            int sobrante = currency.getCantidad() % 50;
            System.out.println("Dispensando " + num + " billetes de 50$");
            if (sobrante != 0) {
